...
<div class="header">
                <a href="{{ route('pages.topicLesson')}}"><img id='back-button' src="{{asset('pages/image/back-button.png')}}" alt=""></a>
...
<div class="answer">
    <div class="row">
        <div class="col-9">
            <div class="row">
                <div style="text-align: center" class="col-sm-6 f" id="{{$tuvung3['id']}}"> 
                <img style="width: 300px; border: 10px outset #8FBC8F;"  src="{{ asset('upload/image/'.$tuvung3->hinhanh) }}"></div>
                        @php $tukhac1= $chude->tuvung->whereNotIn('id', $tuvung3['id']);
                        $tukhac = $tukhac1->shuffle()->take(3); @endphp
                        @foreach($tukhac as $item)

                <div style="text-align: center"  class="col-sm-6 f " style="color:red" id=" {{ $item['id'] }}"> 
                <img style="width: 300px; border: 10px outset #8FBC8F;"   src="{{ asset('upload/image/'.$item->hinhanh) }}"></div>
